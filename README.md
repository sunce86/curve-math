...
|-------|------|----------------|-------------|
| Ethereum | [![Fuzz](https://github.com/sunce86/curve-math/actions/workflows/fuzz-ethereum.yml/badge.svg)](https://github.com/sunce86/curve-math/actions/workflows/fuzz-ethereum.yml) | 70 / 676 ![](https://geps.dev/progress/10?successColor=6366f1) | 2026-03-23 |
